...
function FeedbackForm() {
    ...
    const feedback_type = {
        'qos': 'Please rate the quality of the service you received from your healthcare provider.', 
        'qob': 'Please rate the quality of the medical information provided on our website.',
        'roc': 'Did you find our website user-friendly and informative?',
        'exp': 'Please rate your overall experience with our medical research platform and the accuracy of the diagnoses provided.'
    };
    ...
    return (
        ...
        <Container>
            ...
            (<Card>
                <Card.Header>
                    <cite title="Source Title" className="ded">We are dedicated to ensuring your optimal wellness journey, 
                    and we value your feedback to enhance your health experience. Feel free to share your thoughts with us.
                    </cite>
                </Card.Header>
                <Card.Body>
                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Form.Label className='required-field'>Patient Name</Form.Label>
