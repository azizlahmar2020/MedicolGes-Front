                    ...
                    <div className="row">
                        ...
                        <div className="text" style={{fontSize:'19px'}}>
                            <h1>We Provide <span>Medicol</span> Services That You Can <span>Trust!</span></h1>
                                ...
                                <a href="/myprofile" className="btn" style={{ width: '30%', height: '45px', fontSize: '22px', borderRadius: '4px', paddingTop:'5px' }}>Check My Profile</a>
                                    <a href="/homeprojects" className="btn primary" style={{width:'%', height:'45px', fontSize:'20px', paddingTop:'5px',borderRadius: '4px'}}>Projects & Forms
</a>
                                </div>
                            </div>
                        </div>
